...
<body>
        ...
        <form class="registration-container" action="register_process.php" method="POST" onsubmit="return validateForm()" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                        ...
                        <img id="ProfilePictirePreview" class="mt-2" style="max-width: 400px">
                </div> <br>
        ...
        <script>
                ...
                document.querySelector('input[name="cover"]').addEventListener('change', function(event) {
                        const ProfilePictirePreview = document.getElementById('ProfilePictirePreview');
                        ProfilePictirePreview.src = URL.createObjectURL(event.target.files[0]);
                });
        </script>
